                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <?php $user = $this->ion_auth->user()->row(); ?>
                            <ul class="nav navbar-nav navbar-right">
                                <li><a>Welcome <?php echo $user->first_name; ?> <?php echo $user->last_name; ?></a></li>
                                <li>
                                    <a href="<?php echo site_url('Auth/edit_user/'.$user->id); ?>"><i class="icon-user"></i> Profile</a>
                                </li>
                                <li>
                            ...
                            if ($this->ion_auth->is_admin()): ?>
                                    <li>
                                        <a href="<?php echo site_url('Auth'); ?>"><i class="icon-lock"></i>Admin</a>
                                    </li>
                                    <?php endif; ?>
                            </ul>
                    </div>
